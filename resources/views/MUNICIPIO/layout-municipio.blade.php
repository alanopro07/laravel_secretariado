        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('carga_carta_bancaria') }}" class="nav-link">
                            ...
                            <p class="btn-primario">
                                Cargar carta bancaria
                                <i class="right fas fa-plus"></i>
                            </p>
                        </a>
                    </li>
                    <li class="nav-item has-treeview">
                        <a href="{{ route('carga_carta_cedula') }}" class="nav-link">
                            <i class="nav-icon fas fa-circle"></i>
                            <p class="btn-primario">
                                Carga cedula fiscal
                                <i class="right fas fa-plus"></i>
                    ...
                    <li class="nav-item has-treeview">
                    <a href="{{ route('carga_carta_domicilio') }}" class="nav-link">
                            <i class="nav-icon fas fa-circle"></i>
                            <p class="btn-primario">
                                Cargar datos domicilio
                                <i class="right fas fa-plus"></i>
                            </p>
                        </a>
                    </li>
        ...
        <section class="content">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>contenido de prueba</td>
                    <td>
                        <button type="button" class="btn btn-primary btn-salir" data-toggle="modal" data-target="#exampleModal">ver</button>
                    </td>
                </tr>
                </tbody>
                <tfoot></tfoot>
